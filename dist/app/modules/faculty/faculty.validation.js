...
exports.createFacultyValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        faculty: zod_1.z.object({
            ...
            gender: zod_1.z.enum([...faculty_model_1.Gender]),
            dateOfBirth: zod_1.z.string().optional(),
            email: zod_1.z.string().email(),
            contactNo: zod_1.z.string(),
            emergencyContactNo: zod_1.z.string(),
            bloogGroup: zod_1.z.enum([...faculty_model_1.BloodGroup]),
...
exports.updateFacultyValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        faculty: zod_1.z.object({
            ...
            bloogGroup: zod_1.z.enum([...faculty_model_1.BloodGroup]).optional(),
