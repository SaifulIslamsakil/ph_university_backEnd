...
const admissionSemester_service_1 = require("./admissionSemester.service");
const sendResponse_1 = __importDefault(require("../../utils/sendResponse"));
const http_status_1 = __importDefault(require("http-status"));
const createAcdemicSemester = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const body = req.body;
    const result = yield admissionSemester_service_1.AcademicSemesterServices.createAcdemicSemesterInToDB(body);
...
const getAllAcademicSemesters = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield admissionSemester_service_1.AcademicSemesterServices.getAllAcademicSemestersFormDB();
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const getSingelAcademicSemester = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield admissionSemester_service_1.AcademicSemesterServices.getSingelAcademicSemesterFormDB(req.params.semesterID);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const updateAcademicSemester = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const body = req.body;
    const result = yield admissionSemester_service_1.AcademicSemesterServices.updateAcademicSemesterFormDB(id, body);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
